...
router.get('/', async (req, res) => {
    ...
    res.render('homepage', {franceRecommendations, italyRecommendations, spainRecommendations,
      user_id: req.session.user_id, user_name: req.session.user_name,loggedIn: req.session.loggedIn});
});
